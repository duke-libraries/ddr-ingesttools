require_relative 'ddr_rdr_migrator/column_remover'
require_relative 'ddr_rdr_migrator/column_renamer'
require_relative 'ddr_rdr_migrator/file_path_adder'
require_relative 'ddr_rdr_migrator/license_mapper'
